...
def test_vector_length():
    vector1 = get_vectors("Пример короткого текста")
    vector2 = get_vectors("Пример короткого текста")
    print("длина вектора 1" + str(len(vector1)) + " длина вектора 2" + str(len(vector2)))


if __name__ == "__main__":
    show_info_about_compare_vectors(texts_list=("Пример текста", "Еще больше текста", "Не похож на предыдущие"))
    test_vector_length()   # чем больше текст тем длинее вектор
